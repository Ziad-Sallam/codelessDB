...
//    @Mock private backend.user.UserRepository userRepository;
//
//    @InjectMocks
...
//
//        assertEquals(1, result.getTotalElements());
//        assertEquals(0, result.getContent().get(0).getContributors().size());
//
...
//
//        Pageable pageable = PageRequest.of(0, 10);
//        Page<Object[]> page = new PageImpl<>(List.of(row), pageable, 1);
//
...
//        assertEquals(1L, dtoResult.getUserId());
