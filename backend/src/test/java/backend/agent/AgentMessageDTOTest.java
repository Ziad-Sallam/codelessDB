...
class AgentMessageDTOTest {
    ...
    void constructor_withExplicitCorrelationId_setsAllFields() {
        AgentMessageDTO dto = new AgentMessageDTO("agent", "execute", "corr-2");
    ...
    void constructor_withoutCorrelationId_generatesUuid() {
        AgentMessageDTO dto = new AgentMessageDTO("agent", "run command");
        ...
        assertDoesNotThrow(() -> java.util.UUID.fromString(dto.getCorrelationId()));
    }
}
