...
@AllArgsConstructor
@Schema(
    description = "Represents a SQL data type with optional modifiers like length and precision",
    example = """
    {
      "name": "VARCHAR",
      "length": 255
...
public class SQLDataType {
    ...
    @ArraySchema(
            arraySchema = @Schema(description = "Allowed values for ENUM or SET types"),
            schema = @Schema(example = "ACTIVE")
    )
